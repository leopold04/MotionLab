...
SeededRandom;
class Animation {
  hash: string = SeededRandom.generateHash(); // unique ID for animation
  ...
  constructor(config: AnimationConfig) {
    ...
    emitter.on("collision", this.hash, () => this.handleSound()); // initializing the emitter to listen for 'collision'
